...
it('makes field required for specific locale', function () {
    ...
    $component->assertSchemaComponentExists('title.pl', checkComponentUsing: function ($field) {
...
it('fills data correctly with required locale', function () {
    $data = [
